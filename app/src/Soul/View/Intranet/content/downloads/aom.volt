...
{% block content %}
{% set image_1 = 'img/downloads/aom_ingame.jpg' %}
{% set image_2 = 'img/downloads/aom_ingame2.jpg' %}
{% set image_3 = 'img/downloads/aom_ingame3.jpg' %}
<div class="row">
    ...
    <div class="col-md-12">
        <div class="gutter well">
            ...
            <p>Download de file en installeer deze.<br />
              Start het spel op met aomx.exe of gebruik de Titans snelkoppeling</p>
