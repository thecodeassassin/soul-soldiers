    ...
    <div class="container">
        ...
        <div class="col-md-12 color0 pb15 pt15">
         ...
         <p>Klik op de plaatjes om ze in het groot te bekijken</p>
            {{ image('img/downloads/starcraft_2_ingame.jpg' ,'height': 250, 'width': 250)}}
            {{ image('img/downloads/starcraft_2_ingame2.jpg' ,'height': 250, 'width': 250)}}
            {{ image('img/downloads/starcraft_2_ingame3.jpg' ,'height': 250, 'width': 250)}}
